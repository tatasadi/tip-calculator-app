...
export default function Home() {
  ...
  const tipTotal = Number(state.tipAmount) * Number(state.numberOfPeople)

  const { bill, customTip, numberOfPeople } = state
          ...
          <div className="flex flex-col gap-8 px-8 lg:w-1/2 lg:py-12 lg:pl-12 lg:pr-0">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 lg:grid-cols-3">
                <Button variant="cyan">5%</Button>
                <Button variant="cyan">10%</Button>
                <Button variant="cyan">15%</Button>
                <Button variant="cyan">25%</Button>
                <Button variant="cyan">50%</Button>
                <Input
                  name="customTip"
                  label=""
                  type="text"
          ...
          <div className="px-6 lg:w-1/2 lg:py-8 lg:pl-0 lg:pr-8">
            <div className="bg-neutral-very-dark-cyan flex flex-col rounded-[0.9375rem] px-6 pb-6 pt-[2.44rem] lg:h-full">
              ...
              <Button
                variant="cyan"
                size="lg"
                className="bg-primary-strong-cyan text-neutral-very-dark-cyan hover:bg-neutral-light-cyan focus:bg-neutral-light-cyan mt-auto w-full text-xl uppercase leading-normal"
              >
                Reset
              </Button>
            </div>
